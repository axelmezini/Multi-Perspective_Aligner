...
public class DeclareModel {
    ...
    public DeclareModel(String declareModelPath) throws FileNotFoundException {
        ...
        evaluateLines(sortLines(new File(declareModelPath)));
        createPartitions();
    }

    private HashMap<String, ArrayList<String>> sortLines(File declareFile) throws FileNotFoundException {
    ...
    private void evaluateLines(Map<String, ArrayList<String>> lines) {
        ...
        for (String line : lines.get("constraintLines")) {
            ...
            if (constraint != null) {
                constraint.assignToActivity(activities);
